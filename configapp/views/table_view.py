...
from configapp.models import Table
from configapp.serializers import TableSerializer, RoomSerializer, TableTypeSerializer
from configapp.models.group_model import *
